...
class Pagination
{
    ...
    public static $template = array(
        ...
        'previous_start' => '<li>',
        'prevdisabled_start' => '<li class="disabled">',
        'previous_end'   => '</li>',
        ...
        'next_start'     => '<li>',
        'nextdisabled_start' => '<li class="disabled">',
        'next_end'       => '</li>',
    ...
    public static function next_link()
    {
        ...
        if (static::$current_page == static::$total_pages)
        {
            return static::$template['nextdisabled_start'].\Html::anchor(rtrim('#'), static::$template['next_mark']).static::$template['next_end'];
        }
        else
        {
            $next_page = static::$current_page + 1;
            return static::$template['next_start'].\Html::anchor(rtrim(static::$pagination_url, '/').'/'.$next_page, static::$template['next_mark']).static::$template['next_end'];
        }
    }
    ...
    public static function prev_link()
    {
        ...
        {
            return static::$template['prevdisabled_start'].\Html::anchor(rtrim('#'), static::$template['previous_mark']).static::$template['previous_end'];
        }
        else
        {
            $previous_page = static::$current_page - 1;
            $previous_page = ($previous_page == 1) ? '' : '/'.$previous_page;
            return static::$template['previous_start'].\Html::anchor(rtrim(static::$pagination_url, '/').$previous_page, static::$template['previous_mark'] ).static::$template['previous_end'];
        }
    }
}